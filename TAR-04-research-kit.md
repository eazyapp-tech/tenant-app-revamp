...
> Derived from [[TAR-03 Problem Hypotheses]]. Three instruments, one per audience, each asking only what that audience uniquely knows. Every question carries its scope frame and the hypothesis it tests. Broad quantitative survey comes AFTER interview round one sharpens these — qualitative first, always.
